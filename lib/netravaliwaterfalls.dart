...
class NetravaliWaterfalls extends StatelessWidget {
  final List<String> imageList = [
    'assets/images/NetravaliWaterfalls (1).jpg',
    'assets/images/NetravaliWaterfalls (2).jpg',
    'assets/images/NetravaliWaterfalls (3).jpg',
    'assets/images/NetravaliWaterfalls (4).jpg',
    'assets/images/NetravaliWaterfalls (5).jpg',
  ];
  ...
  final List<Map<String, String>> talukas = [
    {
      "title": "Bubbling Lake",
      "subtitle": "South Goa",
      "image": "assets/images/BubblingLake.jpg"
    },
    {
      "title": "Netravali Wildlife Sanctuary",
      "subtitle": "South Goa",
      "image": "assets/images/NetravaliWildlifeSanctuary.jpg"
    },
    {
      "title": "Bamanbudo Waterfall",
      "subtitle": "South Goa",
      "image": "assets/images/BamanbudoWaterfall.jpg"
    },
    {
      "title": "Rivona Waterfall",
      "subtitle": "South Goa",
      "image": "assets/images/RivonaWaterfall.jpg"
    },
  ];
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.asset(
                          'assets/images/Screenshot 2024-03-31 151931',
                          height: 200,
                          fit: BoxFit.cover,
                        ),
                      ),
