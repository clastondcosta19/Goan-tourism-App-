...
import 'package:goatourism/historicalplace1.dart';
...
class MyListView extends StatelessWidget {
  final List<Map<String, dynamic>> items = [
    {
      'mainItem': 'Acron Resort',
      'subtitle': 'Baga',
      'locationIcon': Icons.location_on,
      'page': HistoricalSitesPage(),
    },
    {
      'mainItem': 'CASA Colvale',
      'subtitle': 'Colvale',
      'locationIcon': Icons.location_on,
      'page': HistoricalSitesPage(),
    },
    {
      'mainItem': 'Famafa Beach Resort',
      'subtitle': 'Arambol',
      'locationIcon': Icons.location_on,
      'page': NaturalWondersPage(),
    },
    {
      'mainItem': 'Lotus Eco Beach Resort',
      'subtitle': 'Benaulim',
      'locationIcon': Icons.location_on,
      'page': NaturalWondersPage(),
    },
    {
      'mainItem': 'Amadi Beach Front Resort',
      'subtitle': 'Mandrem',
      'locationIcon': Icons.location_on,
      'page': NaturalWondersPage(),
    },
              ...
              children: [
                ...
                Positioned.fill(
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.asset(
                      'lib/images/Resorts${index + 1}.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
