...
class PicnicSpot1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AzaansPicnicSpot(),
    );
  }
}

class AzaansPicnicSpot extends StatefulWidget {
  @override
  _AzaansPicnicSpotState createState() => _AzaansPicnicSpotState();
}

class _AzaansPicnicSpotState extends State<AzaansPicnicSpot> {
  bool isBookmarked = false;

  final List<String> imageList = [
    'lib/images/AzaansPicnicSpot1.jpg',
    'lib/images/AzaansPicnicSpot2.jpg',
    'lib/images/AzaansPicnicSpot3.jpg',
    'lib/images/AzaansPicnicSpot4.jpg',
    'lib/images/AzaansPicnicSpot5.jpg',
  ];
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      launch('https://maps.app.goo.gl/uR4nFqCcx9xMYPwo8');
                    },
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(10),
                      child: Image.asset(
                        'lib/images/google_map_AzaansPicnicSpot.jpg',
                        height: 200,
                        fit: BoxFit.cover,
                      ),
                    ),
  ...
  final List<Map<String, String>> attractions = [
    {
      ...
      "subtitle": "Madgao",
      "image": "lib/images/APS1.jpg"
    },
    {
      "title": "Anoshka Family Restaurant",
      "subtitle": "Madgao",
      "image": "lib/images/APS2.jpg"
    },
    {
      "title": "Garça Branca Gardens",
      "subtitle": "Madgao",
      "image": "lib/images/APS3.jpg"
    },
    {
      "title": "Aliza classic cafe",
      "subtitle": "Madgao",
      "image": "lib/images/APS4.jpg"
    },
    {
      "title": "loutolim View point",
      "subtitle": "Madgao",
      "image": "lib/images/APS5.jpg"
    },
    {
      "title": "Our Lady of the Rosary Chapel",
      "subtitle": "Madgao",
      "image": "lib/images/APS6.jpg"
    },
  ];
