...
class CumbarjuaCanal extends StatefulWidget {
  @override
  _CumbarjuaCanalState createState() => _CumbarjuaCanalState();
}

class _CumbarjuaCanalState extends State<CumbarjuaCanal> {
  bool isBookmarked = false; // Variable to track bookmark status

  final List<String> imageList = [
    'lib/images/cumbarjuacanal1.jpg',
    'lib/images/cumbarjuacanal2.jpg',
    'lib/images/cumbarjuacanal3.jpg',
    'lib/images/cumbarjuacanal4.jpg',
    'lib/images/cumbarjuacanal5.jpg',
  ];
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        launch('https://maps.app.goo.gl/CumbarjuaCanal');
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.asset(
  ...
  void toggleBookmark(BuildContext context) {
    setState(() {
      ...
      if (isBookmarked) {
        WishlistApp.addPage("Cumbarjua Canal", CumbarjuaCanal());
      } else {
