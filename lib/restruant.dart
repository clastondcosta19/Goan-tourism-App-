...
import 'package:goatourism/hotels/hotel3Page.dart';
...
class Restruant extends StatelessWidget {
  @override
...
class MyListView extends StatelessWidget {
  final List<Map<String, dynamic>> items = [
    ...
    {
      'mainItem': 'Pousada By the Beach',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage3(),
    },
    {
      'mainItem': 'Matins Corner',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage7(),
    },
    {
      'mainItem': 'Fishermans Whraf',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage11(),
    },
    {
      'mainItem': 'Mums Kitchen',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage12(),
    },
    ...
    {
      'mainItem': 'Calamari Bathe & Binge',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage14(),
    },
    {
      'mainItem': 'Hospedaria Venite Restaurant & Bar',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage16(),
    },
    ...
    {
      'mainItem': 'Antares Restaurant & Beach Club',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage18(),
    },
    {
      'mainItem': 'Soleo Marbella Beach Club Restaurant',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage19(),
    },
    {
      'mainItem': 'The Black Sheep Bistro',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage20(),
    },
    {
      'mainItem': 'Pentagon Restaurant & Garden Pub',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage18(),
    },
    {
      'mainItem': 'The Southern Deck Benaulim',
      'subtitle': 'Restruant',
      'locationIcon': Icons.location_on,
      'page': hotelPage13(),
    }
              ...
              children: [
                ...
                Positioned.fill(
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.asset(
                      'lib/images/restruant${index + 1.0}.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
