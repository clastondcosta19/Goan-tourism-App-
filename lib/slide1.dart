...
class _Slide1State extends State<Slide1> {
  ...
  final List<String> imageList = [
    'lib/images/Slide11.jpg',
    'lib/images/Slide12.jpg',
    'lib/images/Slide13.jpg',
    'lib/images/Slide14.jpg',
    'lib/images/Slide15.jpg',
  ];
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        launch('https://maps.app.goo.gl/Slide1');
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.asset(
                          'lib/images/google_map_Slide1.jpg',
                          height: 200,
                          fit: BoxFit.cover,
                        ),
                      ),
  ...
  void toggleBookmark(BuildContext context) {
    setState(() {
      ...
      if (isBookmarked) {
        WishlistApp.addPage("Cumbarjua Canal", Slide1());
      } else {
