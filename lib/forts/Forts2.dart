...
class ChaporaFort extends StatefulWidget {
  @override
  _ChaporaFortState createState() =>
      _ChaporaFortState();
}

class _ChaporaFortState
    extends State<ChaporaFort> {
  bool isBookmarked = false;

  final List<String> imageList = [
    'lib/images/ChaporaFort1.jpg',
    'lib/images/ChaporaFort2.jpg',
    'lib/images/ChaporaFort3.jpg',
    'lib/images/ChaporaFort4.jpg',
    'lib/images/ChaporaFort5.jpg',
  ];
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      launch('https://maps.app.goo.gl/vU66mmXBXJTkiD3A6');
                    },
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(10),
                      child: Image.asset(
                        'lib/images/google_map_ChaporaFort.jpg',
                        height: 200,
                        fit: BoxFit.cover,
                      ),
                    ),
...
class _AttractionListState extends State<AttractionList> {
  final List<Map<String, String>> attractions = [
    {
      "title": "Vagator Hill View",
      "subtitle": "Anjuna",
      "image": "lib/images/CF1.jpg"
    },
    {
      "title": "W Goa Hotel",
      "subtitle": "Anjuna",
      "image": "lib/images/CF2.jpg"
    },
    {
      "title": "FabHotel Yoyo Cottage",
      "subtitle": "Anjuna",
      "image": "lib/images/CF3.jpg"
    },
    {
      "title": "Chapora Beach",
      "subtitle": "Anjuna",
      "image": "lib/images/CF4.jpg"
    },
    {
      "title": "Vagator Beach",
      "subtitle": "Anjuna",
      "image": "lib/images/CF5.jpg"
    },
    {
      "title": "Olive Kitchen",
      "subtitle": "Anjuna",
      "image": "lib/images/CF6.jpg"
    },
  ];
